          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  const Color.fromARGB(255, 8, 86, 221).withOpacity(0.5),
                  const Color.fromARGB(255, 212, 114, 9).withOpacity(0.9),
                ],
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (error.toString().contains('EMAIL_EXISTS')) {
        ...
        errorMessage =
            'This Email is not valid please enter a valid Email Address';
